var Profile = {
    render() {
        ...
        <div class="pt-6 px-4 text-center">
            ...
            <h1 class="text-3xl font-black chrome-text mb-1">IkyyMusify</h1>
            ...
            <div class="glass rounded-2xl p-5 max-w-sm mx-auto space-y-3 text-left mb-6">
                ...
                <div class="flex justify-between"><span class="text-white/70 text-sm">Nama</span><span class="text-white font-medium text-sm">IkyyMusify</span></div>
            ...
            <a href="https://whatsapp.com/channel/0029Vb7KToAFsn0iBm35UR0T" target="_blank" class="block w-full max-w-sm mx-auto btn-chrome font-bold py-4 rounded-full active:scale-95 transition-all text-center flex items-center justify-center gap-2">
